...
- `pitch_rubric_screenshot.png`
- `implementation_rubric_screenshot.png`
...
|---|---|
| Agent / multi-agent system using ADK | Code |
| MCP Server | Code |
| Antigravity | Video |
| Security features | Code and video |
| Deployability | Video and documentation |
| Agent Skills | Code and video |
...
| Writeup | 10 | Explain problem, solution, architecture, implementation journey, course concept mapping, eval results, and safety limits. |
...
## Hard Rubric Implications

- Agent use must be meaningful and central, not decorative.
- Existing toolsets matter: use ADK, MCP, and Agent Skills deliberately.
- Documentation must be strong enough for a judge to reproduce the work.
- No API keys or passwords may appear in the repository.
- If deployed, provide clear reproduction documentation.
